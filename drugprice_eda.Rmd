...
Looking at Medicare Part D's log transformed Total Spend variabile by year, it appears that the upper qua
...
partd_insulin <- partd %>% 
  ...
  group_by(Year) %>%
  mutate(totalspend = sum(`Total Spending`), totalbens = sum(`Total Beneficiaries`))
