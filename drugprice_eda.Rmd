...
```{r combined_aggregate_trends_5, include = FALSE, eval = FALSE}
...
```{r partd_top_change_table, include = FALSE, eval = FALSE}
partd_brandchng %>%
  filter(Year == 2017) %>%
...
```{r partb_top_change_table, include = FALSE, eval = FALSE}
partb_brandchng %>%
  filter(Year == 2017) %>%
