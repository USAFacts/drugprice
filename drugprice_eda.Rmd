...
partd_cats_all <- partd %>%
  group_by(Year, Category) %>%
  summarise("brandlvl_spend" = sum(`Inf Total Spend`),
            "brandlvl_claims" = sum(`Total Claims`),
            "brandlvl_avg_spend_perclaim" = brandlvl_spend/brandlvl_claims,
            "num_brands" = n_distinct(`Brand Name`)) %>%
  arrange(Category) %>%
  ungroup() %>%
  mutate(Category = str_replace(Category, "pain reliever", "opioid"))

medicaid_cats_all <- medicaid %>%
  group_by(Year, Category) %>%
  summarise("brandlvl_spend" = sum(`Inf Total Spend`),
            "brandlvl_claims" = sum(`Total Claims`),
            "brandlvl_avg_spend_perclaim" = brandlvl_spend/brandlvl_claims,
...
partd_cats_by_year_all <- partd %>%
  mutate(Year = as.numeric(Year)) %>%
  group_by(`Brand Name`) %>%
  arrange(`Brand Name`, Year) %>%
  summarise(num_yrs = n_distinct(Year), first_year = min(Year)) %>%
  right_join(partd, by = "Brand Name") %>%
  group_by(Year, Category, num_yrs, first_year) %>%
  summarise("brandlvl_spend" = sum(`Inf Total Spend`),
            "brandlvl_claims" = sum(`Total Claims`),
            "brandlvl_avg_spend_perclaim" = brandlvl_spend/brandlvl_claims,
            "num_brands" = n_distinct(`Brand Name`)) %>%
...
medicaid_cats_by_year_all <- medicaid %>%
  mutate(Year = as.numeric(Year)) %>%
  group_by(`Brand Name`) %>%
  arrange(`Brand Name`, Year) %>%
  summarise(num_yrs = n_distinct(Year), first_year = min(Year)) %>%
