...
partd %>%
  ggplot(aes(x = `Inf Total Spend`, y = `Total Claims`)) +
  geom_point(stat = "identity", alpha = 0.10) +
...
There are several interesting things to note of the relationship of the change in spend and the change in claims for Medicare Part D between 2013 and 2017:

1. There are several extreme observations that have either increased dramatically in the number of claims per drug or in the spend per drug, but not both. This 
