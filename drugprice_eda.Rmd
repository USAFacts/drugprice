...
Looking at the summary for Medicare Part D, there are four things that jump out at me:

1. The distance between the first two quartiles and then to the max value is heavily right skewed for each of the "Total" metrics. This likely implies there are some crazy outliers for each of the univariate distributions
...
Looking at the summary for Medicare Part B, there are three things that I want to call out:
